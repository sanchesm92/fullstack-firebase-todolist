  ...
  return (
    <div className='flex h-screen justify-center items-center bg-neutral-100 border-2'>
      <section className='container mx-auto flex flex-col items-center w-96 h-80 justify-around shadow-xl bg-neutral-50 '>
        ...
        <label htmlFor="email">
        <input className='shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline' id='email' value={user.email} name='email' type="text" placeholder="Email" onChange={(e) => handleChange(e)} />
        </label>
        <label htmlFor="password">
        <input className='shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline' id='password' value={user.password} name='password' type="password" placeholder="Password" onChange={(e) => handleChange(e)} />
